...
{
public:
    VulkanRenderGroup(IntrusivePtr<Context> context, IntrusivePtr<Graph> graph);
...
private:
    ...
    // subpass name -> graphic pipeline
    std::unordered_map<std::string, IntrusivePtr<VulkanGraphicsPipeline>> pipelineMap;
