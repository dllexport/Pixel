...
int main()
{
    ...
    {
        //  spread drawable to pipelines bindings
        //  resolve || update resource
        //  build command buffer
        //  submmit
    }

    // auto buffer = rhiRuntime->CreateBuffer(Buffer::BUFFER_USAGE_VERTEX_BUFFER_BIT, MemoryProperty::MEMORY_PROPERTY_HOST_VISIBLE_BIT | MemoryProperty::MEMORY_PROPERTY_HOST_COHERENT_BIT, 1024);
    // auto bufferMapRegion = buffer->Map();

    // auto texture = rhiRuntime->CreateTexture(TextureFormat::FORMAT_B8G8R8A8_UNORM,
    //                                          Texture::Usage::IMAGE_USAGE_COLOR_ATTACHMENT_BIT,
    //                                          MemoryProperty::MEMORY_PROPERTY_HOST_VISIBLE_BIT | MemoryProperty::MEMORY_PROPERTY_HOST_COHERENT_BIT,
